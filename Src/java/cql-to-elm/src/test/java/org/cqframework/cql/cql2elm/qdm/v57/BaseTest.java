package org.cqframework.cql.cql2elm.qdm.v57;
...
public class BaseTest {
    ...
    public void testChoiceTypes() throws IOException {
        CqlTranslator translator = TestUtils.runSemanticTest("qdm/v57/TestChoiceTypes.cql", 0);
    ...
    @Test
    public void testNewAttributes() throws IOException {
        TestUtils.runSemanticTest("qdm/v57/TestNewAttributes.cql", 0);
    }
}
